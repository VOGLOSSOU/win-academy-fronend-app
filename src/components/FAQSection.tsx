...
const faqs = [
  {
    question: 'Comment m\'inscrire sur Wurami Innovative Hub ?',
  ...
  },
  {
    ...
    answer: 'Wurami Innovative Hub propose des formations gratuites et payantes. Nous voulons rendre l\'éducation numérique accessible à tous les jeunes béninois.',
  },
  {
    ...
    <section className="faq-section" id="faq">
      <div className="container mx-auto px-4">
        <div className="section-header">
          ...
          <p className="section-subtitle">Tout ce que vous devez savoir sur Wurami Innovative Hub</p>
        </div>
